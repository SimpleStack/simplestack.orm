...
namespace SimpleStack.Orm.MySQLConnector
{
	...
	public class MySqlConnectorExpressionVisitor<T> : SqlExpressionVisitor<T>
	{
		public MySqlConnectorExpressionVisitor(IDialectProvider dialectProvider) : base(dialectProvider)
		{
		}
